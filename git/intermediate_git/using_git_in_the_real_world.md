### Test: Following the lesson

This is an additional section personally added to
follow along with the steps in the lesson about working with git in the real world.
